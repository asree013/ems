    ...
    return (
        <StyleCard>
            <div className={'borders'}>
                ...
                <div className={`${'flexItem'} m-2`}>
                    <p style={{ fontWeight: 600 }}>GA</p>
                    <div className='ml-2'>
                        <input type="radio" value={'nsf'} checked={physical.ga?.toLocaleLowerCase().includes('nsf')} />
                        <label className='ml-2' htmlFor="">NSF</label>
                    </div>
                    <div className='ml-2'>
                        <input type="radio" value={'confuse'} checked={physical.ga?.toLocaleLowerCase().includes('confuse')} />
                        <label className='ml-2' htmlFor="">Confuse</label>
                    </div>
                    <div className='ml-2'>
                        <input type="radio" value={'depress'} checked={physical.ga?.toLocaleLowerCase().includes('depress')} />
                ...
                {
                    physical.airway?.checked?.toLocaleLowerCase() === 'tracheostomy_tube' || 'orotracheal_tube' || 'nasotracheal_tube' ?
                        <div className='m-2' style={{ display: 'flex', alignItems: 'center', justifyContent: 'start' }}>
                ...
                <div className={`m-2 ${'flexItem'}`}>
                    <div className='ml-2'>
                        <input type="radio" value={'o2_cannula'} checked={physical.respi?.respi_checked?.toLocaleLowerCase() === ('o2_cannula')} />
                        <label className='ml-2' htmlFor="">O2 Cannula</label>
                    </div>
                    <div className='ml-2'>
                        <input type="radio" value={'o2_mask'} checked={physical.respi?.respi_checked?.toLocaleLowerCase() === ('o2_mask')} />
                        <label className='ml-2' htmlFor="">O2 Mask</label>
                    </div>
                    <div className='ml-2'>
                        <input type="radio" value={'collar_mask'} checked={physical.respi?.respi_checked?.toLocaleLowerCase() === ('collar_mask')} />
                        <label className='ml-2' htmlFor="">Collar Mask</label>
                    </div>
                    <div className='ml-2'>
                        <input type="radio" value={'t_piece'} checked={physical.respi?.respi_checked?.toLocaleLowerCase() === ('t_piece')} />
