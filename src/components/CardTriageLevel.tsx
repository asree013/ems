    ...
    return (
        <div className='p-3' style={{border: '1px solid black'}}>
            ...
            <div className={style.flexItem}>
                <div className='ml-2'>
                    <input type="radio" value={'resuscitation'} checked={triage.triage_level_value.toLocaleLowerCase().includes('resuscitation') ? true : false} />
                    <label htmlFor="" className='ml-2'>Resuscitation</label>
                </div>
                <div className='ml-2'>
                    <input type="radio" value={'emergency'} checked={triage.triage_level_value.toLocaleLowerCase().includes('emergency') ? true : false} />
                    <label htmlFor="" className='ml-2'>Emergency</label>
                </div>
                <div className='ml-2'>
                    <input type="radio" value={'urgent'} checked={triage.triage_level_value.toLocaleLowerCase().includes('urgent') ? true : false} />
                    <label htmlFor="" className='ml-2'>Urgent</label>
                </div>
                <div className='ml-2'>
                    <input type="radio" value={'non-urgent'} checked={triage.triage_level_value.toLocaleLowerCase().includes('non-urgent') ? true : false} />
                    <label htmlFor="" className='ml-2'>Non-urgent</label>
                </div>
            </div>
            <div style={{border: '0.5px solid black'}} className='mt-3'></div>
            <p className='mt-2' style={{ textDecoration: 'underline', fontWeight: 600 }}>V/S</p>
            <div className={style.flexItem}>
